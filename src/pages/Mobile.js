    ...
    return (
        ...
        <section className='mobile-background'>
            <section className='container-programacao'>
                <h1 className="titulo-programacao">Mobile</h1>
                <section className='container-border-programacao'>
                    <section className='container-border-mobile2'></section>
                </section>
                                    ...
                                    <div id="carouselExampleIndicators2" className="carousel slide" data-ride="carousel">
                                        ...
                                        <div className="carousel-inner">
                                            ...
                                            <div className="carousel-item active ">
                                                <div className="row ">
                                                    {data.filter((name) => name.time.includes('Mobile')).map((filteredtime) => (
                                                        ...
                                                        <div key={filteredtime.id} className="col-md-4 mb-3 container-card-programacao">
                                                            ...
                                                            <div className="card">
                                                                ...
                                                                <div className="card-body">
                                                                    ...
                                                                    <p className="card-text"><span className='span-programacao'><SiUndertale className="icon-mobile"></SiUndertale> Cargo:</span> {filteredtime.cargo}</p>

                                                                    <div className=''>
                                                                        <div className='container-button'>
                                                                            
                                                                           <Link to={`/editar/${filteredtime.id}`}> <button type="button" onClick={(() => editar(filteredtime.id,filteredtime.time))} className="btn btn-primary button-mobile-style"><MdBuild className='icon-time2'></MdBuild> Editar</button></Link>

                                                                                   
                                                                                        
                                                                            <button type='button'  className="btn btn-primary button-mobile-style" onClick={(e) =>deletar(filteredtime.id)}>
